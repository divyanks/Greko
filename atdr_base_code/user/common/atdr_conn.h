...
struct ebdr_conn_operations
{
	...
	int (* do_ebdr_conn_send) (void *buf, int size, int sockfd, enum send_rcv_type_t send_type);
	int (* do_ebdr_conn_recv) (void *buf, int size, int sockfd, enum send_rcv_type_t send_type, int pid);

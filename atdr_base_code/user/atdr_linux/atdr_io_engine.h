...
struct ebdr_io_engine_ops
{
	...
	int (*chunk_read)(int fd, char *buff, unsigned long int size, unsigned long int start_lba);
	int (*chunk_write)(int fd, char *buff, unsigned long int size, unsigned long int start_lba);

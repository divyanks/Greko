...
struct ebdr_bitmap_operations
{
	...
	int (*load_bitmap_from_disk)(struct ebdr_user_bitmap *ubitmap, int pid);
	int (*store_bitmap_to_disk)(struct ebdr_user_bitmap *ubitmap, int pid);
